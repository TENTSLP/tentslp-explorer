...
<url><loc>https://testnet-slp.tent.app/</loc></url>
<url><loc>https://testnet-slp.tent.app/alltokens</loc></url>
<url><loc>https://testnet-slp.tent.app/dividend</loc></url>
<url><loc>https://testnet-slp.tent.app/block/mempool</loc></url>`;


  return slpdbQuery(tokens_query)
    .then((data) => {
      for (const m of data.t) {
        response += `<url><loc>https://testnet-slp.tent.app/token/${m.tokenDetails.tokenIdHex}</loc></url>\n`;
      }

      return slpdbQuery(addresses_query)
        .then((data) => {
          for (const m of data.g) {
            response += `<url><loc>https://testnet-slp.tent.app/address/${m._id}</loc></url>\n`;
          }

          return slpdbQuery(transactions_query)
            .then((data) => {
              for (const m of data.c) {
                response += `<url><loc>https://testnet-slp.tent.app/tx/${m.tx.h}</loc></url>\n`;
              }
